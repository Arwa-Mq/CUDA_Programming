...
// CPU routine
////////////////////////////////////////////////////////////////////////
// I belive this is the reduction function that will be used for the sum >>Arwa
...
// GPU routine
////////////////////////////////////////////////////////////////////////
// the Kernal part of the code for GPU , sum the element and put the output on the g_odata.>>Arwa
__global__ void reduction(float *g_odata, float *g_idata)
{
    ...
    // the importent part of the function that do the reduction in action>> Arwa
